...
// Enable Rising Edge Detect for the specified pin.
void bcm2835_gpio_ren(uint8_t pin);

// Disable Rising Edge Detect for the specified pin.
void bcm2835_gpio_clr_ren(uint8_t pin);

// Enable Falling Edge Detect for the specified pin.
void bcm2835_gpio_fen(uint8_t pin);

// Disable Falling Edge Detect for the specified pin.
void bcm2835_gpio_clr_fen(uint8_t pin);

// Enable High Detect for the specified pin.
void bcm2835_gpio_hen(uint8_t pin);

// Disable High Detect for the specified pin.
void bcm2835_gpio_clr_hen(uint8_t pin);

// Enable Low Detect for the specified pin.
